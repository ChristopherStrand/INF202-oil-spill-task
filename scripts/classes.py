            ...
            if len(cell.points) == 3:
                for other_cell in self._cells:
                    if other_cell != cell:
                        ...
                        shared_points = set(cell._points).intersection(
                            set(other_cell._points)
                        )
                ...
                for other_cell in self._cells:
                    if other_cell != cell:
                        ...
                        if (
                            len(shared_points) == 1
                            and len(other_cell.points) == 2
                            or len(shared_points) == 2
                            and len(other_cell.points) == 3
                        ):
                            neighbors.append(other_cell)
